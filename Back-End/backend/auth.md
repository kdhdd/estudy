...
- 인증과 달리 인가는 어떤 개체가 어떤 리소스에 접근할 수 있는지 또는 어떤 동작을 수행할 수 있는지 검증하는 것, 즉 "너 이거 해도 돼?" 라는 질문에 답하는 것이다.
...
- 인증은 유저나 디바이스의 신원을 `증명`하는 행위다. → "나 이 사람 맞아요"
- 인가는 유저나 디바이스에게 접근 권한을 부여하거나 거부하는 행위다. → "이 사람은 여기까지 할 수 있어요"
